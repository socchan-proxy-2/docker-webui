...
if __name__ == '__main__':
    ...
    context.use_certificate_file('/etc/letsencrypt/live/your-domain.com/fullchain.pem')
    context.use_privatekey_file('/etc/letsencrypt/live/your-domain.com/privkey.pem')
